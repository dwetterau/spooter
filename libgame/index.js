...
(function() {
  var BULLET_MIN_SIZE, BULLET_SIZE_FACTOR, BULLET_SPEED, ENEMY_MIN_SIZE, ENEMY_SHRINKAGE, ENEMY_SIZE_RANGE, ENEMY_SPAWN_PERCENTAGE, Game, LOOP_TIME_INTERVAL, MAX_ENEMIES, MIN_ENEMIES, PLAYER_ACCELERATION_LIMIT, PLAYER_SPEED_LIMIT,
  ...
  Game = (function() {
    ...
    Game.prototype.movePlayer = function(player, dt) {
      var clampedX, clampedY, mag, speed;
